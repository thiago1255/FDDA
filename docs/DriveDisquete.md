...
### Pinos de cima
 ...
 11. [Grava dados.](# Sinais de gravação)
 12. Ativar gravação quando em 0v.
 13. Manda sinal de 0v quando na faixa mais externa do disco.
 14. Indica que o disco está [em proteção contra gravação](### Anti-gravação) quando em 0v.
 15. [Leitura dos dados do disco.](# Sinais de gravação)
